...
"QPushButton:pressed {background-color:rgb(212, 212, 212);}")
        ...
        self.connection_error.setGeometry(QtCore.QRect(10, 770, 161, 21))
        ...
        self.no_msgs_label.setObjectName("no_msgs_label")
        self.chats.raise_()
        ...
        self.connection_error.raise_()
        self.no_msgs_label.raise_()
