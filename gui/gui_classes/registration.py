...
"QLabel {color:rgb(28, 94, 217,);}")
        ...
        self.password_in.setGeometry(QtCore.QRect(280, 350, 231, 40))
        self.password_in.setStyleSheet("padding: 5; border-radius: 10px; border: 1px solid #CCCCCC; font: 25 8pt \"Yu Gothic UI Light\";")
        ...
        self.email_in.setGeometry(QtCore.QRect(280, 270, 231, 40))
